...
<tr>
    ...
    <th class="wide">{'Agency'|i18n( 'design/admin/shop/orderlist' )}</th>
...
<tr class="{$Orders.sequence}">
    ...
    {* Agency Column *}
    {set $agency = fetch("content", "object", hash('object_id', $Orders.item.user_id)).data_map.agency}
    <td>{if $agency.has_content}{$agency.content}{else}n/a{/if}</td>

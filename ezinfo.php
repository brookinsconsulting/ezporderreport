<?php
/**
 * File containing the ezporderreportInfo class.
 *
 ...
 */
class ezporderreportInfo
{
    function info()
    {
        return array(
            'Name' => "<a href='http://bitbucket.org/brookinsconsulting/ezporderreport'>eZp Order Report</a>",
            'Version' => "0.1.5",
